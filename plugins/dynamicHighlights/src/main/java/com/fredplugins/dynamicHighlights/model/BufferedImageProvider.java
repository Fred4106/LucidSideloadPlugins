...
import static com.fredplugins.dynamicHighlights.FredsLootFiltersPlugin.ICON_DIRECTORY;

@Slf4j
public abstract class BufferedImageProvider {
    //Height only applies to item icons
    public abstract BufferedImage getImage(FredsLootFiltersPlugin plugin, PluginTileItem item, int... height);
    ...
    public static final class Sprite extends BufferedImageProvider {
        ...
        @Override
        public BufferedImage getImage(FredsLootFiltersPlugin plugin, PluginTileItem item, int... height) {
            try {
