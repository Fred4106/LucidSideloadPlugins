...
import static com.fredplugins.pvmHelper.inferno.InfernoWaveMappings.addWaveComponent;
...
public class InfernoWaveOverlay extends Overlay
{
	...
	@Inject
	InfernoWaveOverlay(final FredsInfernoPlugin plugin, final FredsInfernoConfig config)
	{
		this.plugin = plugin;
		this.config = config;
