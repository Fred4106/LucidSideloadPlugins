...
{
	final String GroupName = "fredsTeleportMaps";
	...
	String KEY_SHOW_CLUECOMPASS_MAP = "showClueCompassMap";
	String KEY_SHOW_CLUECOMPASS_MAP_HOTKEYS = "showClueCompassMapHotkeys";
	...
	@ConfigSection(
		name = "Clue Compass Settings",
		description = "Settings related to the Clue Compass",
		position = 3
	)
	String clueCompassMap = "clueCompassMap";
	...
	@ConfigItem(
		keyName = KEY_SHOW_CLUECOMPASS_MAP,
	...
	@ConfigItem(
		keyName = KEY_SHOW_CLUECOMPASS_MAP_HOTKEYS,
		name = "Show hotkey on ",
		description = "Display the teleport hotkeys as icons",
		section = clueCompassMap,
		position = 1
	)
	default boolean showClueCompassMapHotkeys()
	{
		return true;
	}
