...
public class XericsMap extends BaseMap implements IAdventureMap
{
	...
	@Inject
	public XericsMap(FredsTeleportMapsPlugin plugin, FredsTeleportMapsConfig config, Client client, ClientThread clientThread)
	{
	...
	public void onConfigChanged(ConfigChanged e)
	{
		switch (e.getKey())
		{
			case FredsTeleportMapsConfig.KEY_SHOW_XERICS_MAP:
				this.setActive(config.showXericsMap());
			case FredsTeleportMapsConfig.KEY_SHOW_XERICS_MAP_LABELS:
			case FredsTeleportMapsConfig.KEY_SHOW_XERICS_MAP_HOTKEY_LABELS:
			case FredsTeleportMapsConfig.KEY_DISPLAY_HOTKEYS:
