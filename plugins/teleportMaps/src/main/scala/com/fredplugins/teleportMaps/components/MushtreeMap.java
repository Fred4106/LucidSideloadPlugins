...
import com.fredplugins.teleportMaps.ui.Mushtree;
import com.fredplugins.teleportMaps.ui.UIButton;
...
public class MushtreeMap extends BaseMap
{
	...
	@Inject
	public MushtreeMap(FredsTeleportMapsPlugin plugin, FredsTeleportMapsConfig config, Client client, ClientThread clientThread)
	{
	...
	public void onConfigChanged(ConfigChanged e)
	{
		switch (e.getKey())
		{
			case FredsTeleportMapsConfig.KEY_SHOW_MUSHTREE_MAP:
