...
import com.fredplugins.teleportMaps.ui.Tree;
...
public class SpiritTreeMap extends BaseMap implements IAdventureMap
{
	...
	@Inject
	public SpiritTreeMap(FredsTeleportMapsPlugin plugin, FredsTeleportMapsConfig config, Client client, ClientThread clientThread)
	{
	...
	public void onConfigChanged(ConfigChanged e)
	{
		switch (e.getKey())
		{
			case FredsTeleportMapsConfig.KEY_SHOW_SPIRIT_TREE_MAP:
	...
	private void buildAvailableTreeList()
	{
		...
		for (Widget child : labelWidgets)
		{
			...
			log.debug("childText=\"{}\"", child.getText());
