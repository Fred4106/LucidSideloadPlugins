...
public abstract class BaseMap implements IMap
{
	...
	public BaseMap(FredsTeleportMapsPlugin plugin, TeleportMapsConfig config, Client client, ClientThread clientThread)
	{
		this.plugin = plugin;
		this.config = config;
		this.client = client;
	...
	final protected void addTeleport(UITeleport teleport)
	{
		this.activeUITeleports.add(teleport);
	}

	final protected void clearTeleports()
	{
