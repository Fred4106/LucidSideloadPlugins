...
import com.fredplugins.teleportMaps.definition.ObeliskDefinition;
...
public class WildernessObeliskMap extends BaseMap implements IAdventureMap
{
	...
	@Inject
	public WildernessObeliskMap(FredsTeleportMapsPlugin plugin, FredsTeleportMapsConfig config, Client client, ClientThread clientThread)
	{
	...
	public void onConfigChanged(ConfigChanged e)
	{
		switch (e.getKey())
		{
			case FredsTeleportMapsConfig.KEY_SHOW_OBELISK_MAP:
				this.setActive(config.showObeliskMap());
			case FredsTeleportMapsConfig.KEY_SHOW_OBELISK_MAP_LABELS:
			case FredsTeleportMapsConfig.KEY_SHOW_OBELISK_MAP_HOTKEY_LABELS:
