...
import com.fredplugins.teleportMaps.definition.MinecartDefinition;
...
public class MinecartMap extends BaseMap implements IAdventureMap
{
	...
	@Inject
	public MinecartMap(FredsTeleportMapsPlugin plugin, FredsTeleportMapsConfig config, Client client, ClientThread clientThread)
	{
	...
	public void onConfigChanged(ConfigChanged e)
	{
		switch (e.getKey())
		{
			case FredsTeleportMapsConfig.KEY_SHOW_MINECART_MAP:
