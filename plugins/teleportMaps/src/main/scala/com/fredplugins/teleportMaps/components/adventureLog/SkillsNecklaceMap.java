...
import com.fredplugins.teleportMaps.definition.SkillsNecklaceDefinition;
...
public class SkillsNecklaceMap extends BaseMap implements IAdventureMap
{
	...
	@Inject
	public SkillsNecklaceMap(FredsTeleportMapsPlugin plugin, FredsTeleportMapsConfig config, Client client, ClientThread clientThread)
	{
	...
	public void onConfigChanged(ConfigChanged e)
	{
		switch (e.getKey())
		{
			case FredsTeleportMapsConfig.KEY_SHOW_SKILLS_NECKLACE_MAP:
