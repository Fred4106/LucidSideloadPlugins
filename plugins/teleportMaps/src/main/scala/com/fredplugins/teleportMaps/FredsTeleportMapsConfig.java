...
@ConfigGroup(FredsTeleportMapsConfig.GROUP)
public interface FredsTeleportMapsConfig extends Config
{
	static final String GROUP = "fredsteleportmaps";
	final static String KEY_DISPLAY_HOTKEYS = "displayHotkeys";
	final static String KEY_SHOW_SPIRIT_TREE_MAP = "showSpiritTreeMap";
	final static String KEY_SHOW_MUSHTREE_MAP = "showMushtreeMap";
	final static String KEY_SHOW_MINECART_MAP = "showMinecartMap";
	final static String KEY_SHOW_XERICS_MAP = "showXericsMap";
	final static String KEY_SHOW_XERICS_MAP_LABELS = "showXericsMapLabels";
	final static String KEY_SHOW_XERICS_MAP_HOTKEY_LABELS = "showXericsMapHotkeyInLabels";
	final static String KEY_SHOW_OBELISK_MAP = "showObeliskMap";
	final static String KEY_SHOW_OBELISK_MAP_LABELS = "showObeliskMapLabels";
	final static String KEY_SHOW_OBELISK_MAP_HOTKEY_LABELS = "showObeliskMapHotkeyInLabels";
	final static String KEY_SHOW_SKILLS_NECKLACE_MAP = "showSkillsNecklaceMap";
