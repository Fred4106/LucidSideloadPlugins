...
import net.runelite.api.gameval.ItemID.{BLUE_DRAGONHIDE_BODY, BLUE_DRAGONHIDE_CHAPS, BLUE_DRAGON_VAMBRACES, RED_DRAGONHIDE_BODY, RED_DRAGONHIDE_CHAPS, RED_DRAGON_VAMBRACES, BLACK_DRAGONHIDE_BODY, BLACK_DRAGONHIDE_CHAPS, BLACK_DRAGON_VAMBRACES}
...
//								log.info("VarbitID.SPELLBOOK_SUBLIST({}) => spellbookId({})", spellBookId_varbit_book_sublist, spellbookId)
	...
	private object Alchable {
		...
		private lazy val listOfAlches: List[Int] = List(bowAlches, staffAlches, mithrilAlches, adamantAlches, runeAlches, dhideAlches).flatten
