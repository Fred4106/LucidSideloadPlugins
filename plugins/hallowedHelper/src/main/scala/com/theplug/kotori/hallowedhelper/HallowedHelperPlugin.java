...
import ethanApiPlugin.interactionApi.NPCInteraction;
...
public class HallowedHelperPlugin extends Plugin {
	...
	//    final LocatableQueryResults<GroundObject> groundObjectResults = new GroundObjectQuery().result(client);
		...
		List<Integer> validNpcIds = Stream.concat(SWORD_IDS.stream(), ARROW_IDS.stream()).collect(Collectors.toList());
		List<NPC> npcs = NPCs.search().idInList(validNpcIds).result();
	...
	LocalPoint floor4LeftLocation = new LocalPoint(6016, 8704, 0);
	LocalPoint floor4RightLocation = new LocalPoint(6016, 9344, 0);
	LocalPoint floor4BottomLocation1 = new LocalPoint(7296, 8704, 0);
	LocalPoint floor4BottomLocation2 = new LocalPoint(7296, 9344, 0);
	LocalPoint floor4BottomLocation3 = new LocalPoint(7040, 8704, 0);
	...
	LocalPoint floor5TopLeft_lp = new LocalPoint(4096, 9088, 0);
	LocalPoint floor5BottomLeft_lp = new LocalPoint(5632, 9088, 0);
	...
	LocalPoint floor5_2ATopLeft_lp = new LocalPoint(3840, 9088, 0);
	LocalPoint floor5_2A1OneUnderTopLeft_lp = new LocalPoint(4096, 9088, 0);
	...
	LocalPoint floor5_4BottomLeft_lp = new LocalPoint(8960, 8448, 0);
	LocalPoint floor5_4BottomRight_lp = new LocalPoint(8960, 9088, 0);
	...
	LocalPoint floor4_SouthA_BottomLeft_LP = new LocalPoint(5248,5120, 0);
	LocalPoint floor4_SouthA_BottomMiddle_LP = new LocalPoint(4736,5120, 0);
	...
	LocalPoint floor4_SouthB_BottomLeft_LP = new LocalPoint(3328,2944, 0);
	LocalPoint floor4_SouthB_TopLeft_LP = new LocalPoint(3328,3968, 0);
