...
@ConfigGroup(value = FredsYamaConfig.GroupName, secondaryConfig = true)
public interface FredsYamaConfig extends Config {
	static final String GroupName = "FredsYamaHelper";

	@ConfigItem(
		name = "Enabled",
		description = "Is Yama helper enabled?",
		position = 0,
		keyName = "enabled"
	)
	...
	default YamaMode mode() {
		return YamaMode.FULL_AUTO;
	}

	@ConfigSection(
		name = "Yama Settings",
		description = "Settings for Yama boss helper",
		position = 1
	)
	...
	@ConfigItem(
		...
		description = "Automatically switch prayers for Yama.",
		section = yamaSection,
		position = 2
	)
	...
	@ConfigItem(
		...
		description = "Automatically switch gear for Yama.",
		section = yamaSection,
		position = 4
	)
