...
@ConfigGroup(value = FredsMuspahConfig.GROUP, secondaryConfig = true)
public interface FredsMuspahConfig extends Config {
	static final String GROUP = "FredsMuspahHelper";
