...
@ConfigGroup(value = FredsPvmDebuggerConfig.GroupName)
public interface FredsPvmDebuggerConfig extends Config {
	static final String GroupName = "FredsPvmDebugger";
	//region Debug
	@ConfigSection(
		name = "Debug",
