...
import com.fredplugins.pvmDebugger.inferno.displaymodes.InfernoSafespotDisplayMode;
...
public class InfernoOverlay extends Overlay
{
	...
	@Inject
	private InfernoOverlay(final Client client, final InfernoPlugin plugin, final FredsInfernoConfig config)
	{
		this.client = client;
		this.plugin = plugin;
		this.config = config;
