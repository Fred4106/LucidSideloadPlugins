...
public class C_ForestryBasket extends ChargedItemWithStorage {
    ...
    public C_ForestryBasket(final Provider provider) {
        super(com.fred4106.improvedCharges.Constants.FORESTRY_BASKET, ItemId.FORESTRY_BASKET, provider);
    ...
    private void purchaseFromFriendlyForesterShop(final int amountToBuy) {
        final Optional<Widget> forestryShopWidget = FredsItemChargesPlugin.getWidget(provider.client, 819, 3);
