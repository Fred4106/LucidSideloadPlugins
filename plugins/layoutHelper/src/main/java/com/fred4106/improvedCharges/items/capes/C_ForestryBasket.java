...
public class C_ForestryBasket extends ChargedItemWithStorage {
    ...
    public C_ForestryBasket(Provider provider) {
        super(FredsItemChargesConfig.forestry_basket, ItemID.FORESTRY_BASKET_CLOSED, provider);

        forestryKit = new C_ForestryKit(FredsItemChargesConfig.forestry_basket, ItemID.FORESTRY_BASKET_CLOSED, ItemID.FORESTRY_BASKET_OPEN, storage, provider);
        logBasket = new C_LogBasket(FredsItemChargesConfig.forestry_basket, ItemID.FORESTRY_BASKET_CLOSED, ItemID.FORESTRY_BASKET_OPEN, storage, provider);
