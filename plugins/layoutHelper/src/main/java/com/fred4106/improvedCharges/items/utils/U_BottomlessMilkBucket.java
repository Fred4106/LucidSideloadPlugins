...
public class U_BottomlessMilkBucket extends ChargedItemWithStorage {
    public U_BottomlessMilkBucket(Provider provider) {
        super(FredsItemChargesConfig.bottomless_milk_bucket, ItemID.BOTTOMLESS_MILK_BUCKET_FILLED, provider);
        ...
        this.triggers.addAll(List.of(
            ...
            new OnChatMessage("Your bottomless milk bucket is currently holding (?<charges>.+) uses? of (?<type>.+).").matcherConsumer(m -> {
                Optional<StorageItem> storageItem = getStorageItemFromName(m.group("type"), FredsItemChargesPlugin.getNumberFromCommaString(m.group("charges")));
