...
public class C_ForestryKit extends ChargedItemWithStorage {
    ...
    public C_ForestryKit(Provider provider) {
        super(FredsItemChargesConfig.forestry_kit, ItemID.FORESTRY_KIT, provider);
    ...
    private void purchaseFromFriendlyForesterShop(int amountToBuy) {
        Optional<Widget> forestryShopWidget = FredsItemChargesPlugin.getWidget(provider.client, 819, 3);
