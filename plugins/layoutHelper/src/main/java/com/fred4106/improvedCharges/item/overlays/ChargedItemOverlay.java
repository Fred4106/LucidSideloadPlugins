...
public class ChargedItemOverlay extends WidgetItemOverlay {
    ...
    public void renderItemOverlay(final Graphics2D graphics, final int itemId, final WidgetItem widgetItem) {
        ...
        final int itemOverlayX = (int) ((
            provider.config.itemOverlayLocation() == com.fred4106.improvedCharges.Constants.ItemOverlayLocation.BOTTOM_LEFT ||
            provider.config.itemOverlayLocation() == com.fred4106.improvedCharges.Constants.ItemOverlayLocation.TOP_LEFT
        )
            ? bounds.getMinX()
        ...
        final int itemOverlayY = (int) ((
            provider.config.itemOverlayLocation() == com.fred4106.improvedCharges.Constants.ItemOverlayLocation.TOP_LEFT ||
            provider.config.itemOverlayLocation() == com.fred4106.improvedCharges.Constants.ItemOverlayLocation.TOP_RIGHT
        )
    ...
    private boolean isChargedItemOverlayEnabled(final ChargedItemBase chargedItem) {
        final String configKey = chargedItem.getConfigKey() + com.fred4106.improvedCharges.Constants._OVERLAY;
