...
public class ChargedItemOverlay extends WidgetItemOverlay {
    ...
    public void renderItemOverlay(Graphics2D graphics, int itemId, WidgetItem widgetItem) {
        ...
        int itemOverlayX = (int) ((
            provider.config.itemOverlayLocation() == FredsItemChargesConfig.ItemOverlayLocation.BOTTOM_LEFT ||
            provider.config.itemOverlayLocation() == FredsItemChargesConfig.ItemOverlayLocation.TOP_LEFT
        )
            ? bounds.getMinX()
        ...
        int itemOverlayY = (int) ((
            provider.config.itemOverlayLocation() == FredsItemChargesConfig.ItemOverlayLocation.TOP_LEFT ||
            provider.config.itemOverlayLocation() == FredsItemChargesConfig.ItemOverlayLocation.TOP_RIGHT
        )
    ...
    private boolean isChargedItemOverlayEnabled(ChargedItemBase chargedItem) {
        String configKey = chargedItem.getConfigKey() + FredsItemChargesConfig._overlay;
