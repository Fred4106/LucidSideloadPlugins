...
public class U_HuntsmansKit extends ChargedItemWithStorage {
    public U_HuntsmansKit(Provider provider) {
        super(FredsItemChargesConfig.huntsmans_kit, ItemID.HUNTSMANS_KIT, provider);
        ...
        this.triggers.addAll(List.of(
            // Fill from inventory.
            new OnItemContainerChanged(InventoryID.INV).fillStorageFromInventory().onMenuOption("Fill", FredsItemChargesPlugin.menuOptionFillFromInventory),

            // Empty to inventory.
            new OnItemContainerChanged(InventoryID.INV).emptyStorageToInventory().onMenuOption("Empty", FredsItemChargesPlugin.menuOptionEmptyToInventory),
