	...
	public void onDestinationChanged(DestinationChanged evt)
	{
		if (evt.getTo() != null) {
			...
			if (action != null && ( action == ActionEnum.FLETCH_ATTACH
				|| action == ActionEnum.FLETCH_CUT_ARROW_SHAFT
				|| action == ActionEnum.FLETCH_CUT_BOW
				|| action == ActionEnum.FLETCH_CUT_TIPS
				|| action == ActionEnum.FLETCH_ATTACH_TIPS
				|| action == ActionEnum.FLETCH_CUT_TIPS_AMETHYST
				|| action == ActionEnum.FLETCH_STRING_BOW
				|| action == ActionEnum.FLETCH_ATTACH_CROSSBOW
				|| action == ActionEnum.FLETCH_STRING_CROSSBOW
				|| action == ActionEnum.FLETCH_JAVELIN
				|| action == ActionEnum.FLETCH_DART
        || action == ActionEnum.GUARDIAN_OF_THE_RIFT_REWARD_POOL
        || action == ActionEnum.GUARDIAN_OF_THE_RIFT_CRAFTING)) {
				return;
			}
