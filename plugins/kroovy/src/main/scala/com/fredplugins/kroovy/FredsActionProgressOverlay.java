...
@Singleton
public class FredsActionProgressOverlay extends Overlay
{
	...
	@Inject private FredsActionProgressPlugin plugin;
...
//
			...
			String header = String.format("Freds %s", this.plugin.getCurrentActionName());
			...
			Graphics2D g, String header, String count, String timeString, Image icon, long min, long max, long value, Dimension preferredDimension)
	{
		...
		int preferredWidth = preferredDimension != null ? (int)preferredDimension.getWidth() : 250;
		int preferredHeight = preferredDimension != null ? (int)preferredDimension.getHeight() : 75;
