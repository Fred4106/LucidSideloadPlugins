...
public interface Magic
{
	...
	enum Rune {
		AIR("Air", RuneIDs.AIR, StaveIDs.AIR),
		WATER("Water", RuneIDs.WATER, IDs.of(StaveIDs.WATER, ItemID.TOME_OF_WATER)),
		EARTH("Earth", RuneIDs.EARTH, IDs.of(StaveIDs.EARTH, ItemID.TOME_OF_EARTH)),
		FIRE("Fire", RuneIDs.FIRE, IDs.of(StaveIDs.FIRE, ItemID.TOME_OF_FIRE)),
		MIND("Mind", RuneIDs.MIND),
		BODY("Body", RuneIDs.BODY),
		COSMIC("Cosmic", RuneIDs.COSMIC),
		CHAOS("Chaos", RuneIDs.CHAOS),
		ASTRAL("Astral", RuneIDs.ASTRAL),
		NATURE("Nature", RuneIDs.NATURE),
		LAW("Law", RuneIDs.LAW),
		DEATH("Death", RuneIDs.DEATH),
		BLOOD("Blood", RuneIDs.BLOOD),
		SOUL("Soul", RuneIDs.SOUL),
		WRATH("Wrath", RuneIDs.WRATH);

		private final String name;

		private final IDs runeIds;

		private final IDs unlimitedSources;
		...
		Rune(String name, IDs runeId) {
			this(name, runeId, IDs.empty);
		}

		private Rune(String name, IDs runeIds, IDs unlimitedSources) {
			this.name = name;
		...
		public int countAvailable(Client client) {
			for (int itemId : this.unlimitedSources.build()) {
			...
			for (int itemId : this.runeIds.build()) {
	...
	interface RuneIDs
	{
		...
		IDs SMOKE = IDs.of(ItemID.SMOKE_RUNE);
		IDs DUST = IDs.of(ItemID.DUST_RUNE);
		IDs LAVA = IDs.of(ItemID.LAVA_RUNE);
		IDs MIST = IDs.of(ItemID.MIST_RUNE);
		IDs MUD = IDs.of(ItemID.MUD_RUNE);
		IDs STEAM = IDs.of(ItemID.STEAM_RUNE);
		IDs AIR = IDs.of(
				SMOKE,
				DUST,
				MIST,
