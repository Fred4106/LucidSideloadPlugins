...
@ConfigGroup(FredsZulrahHelperPlugin.CONFIG_GROUP)
public interface FredsZulrahHelperConfig extends Config
{
	@ConfigSection(
		name = FredsZulrahHelperPlugin.SECTION_IMAGE_OPTIONS,
		description = "All the options for image options",
		position = 0
	)
	String SECTION_IMAGE_OPTIONS = FredsZulrahHelperPlugin.SECTION_IMAGE_OPTIONS;

	@ConfigSection(
		name = FredsZulrahHelperPlugin.SECTION_HOTKEYS,
	...
	@ConfigSection(
		name = FredsZulrahHelperPlugin.SECTION_MISC,
		description = "Miscellaneous options for the plugin",
		position = 2
	)
	String SECTION_MISC = FredsZulrahHelperPlugin.SECTION_MISC;

	@ConfigItem(
		keyName = FredsZulrahHelperPlugin.DISPLAY_PRAYER_KEY,
		section = FredsZulrahHelperPlugin.SECTION_IMAGE_OPTIONS,
		name = "Prayer Icons",
	...
	@ConfigItem(
		keyName = FredsZulrahHelperPlugin.DISPLAY_ATTACK_KEY,
		section = FredsZulrahHelperPlugin.SECTION_IMAGE_OPTIONS,
		name = "Attack Icons",
	...
	@ConfigItem(
		keyName = FredsZulrahHelperPlugin.DISPLAY_VENOM_KEY,
		section = FredsZulrahHelperPlugin.SECTION_IMAGE_OPTIONS,
		name = "Venom Icons",
	...
	@ConfigItem(
		keyName = FredsZulrahHelperPlugin.DISPLAY_SNAKELINGS_KEY,
		section = FredsZulrahHelperPlugin.SECTION_IMAGE_OPTIONS,
	...
	@ConfigItem(
		keyName = FredsZulrahHelperPlugin.DARK_MODE_KEY,
		section = FredsZulrahHelperPlugin.SECTION_IMAGE_OPTIONS,
		name = "Dark Mode",
	...
	@ConfigItem(
		keyName = FredsZulrahHelperPlugin.MAGE_COLOR_KEY,
		section = FredsZulrahHelperPlugin.SECTION_IMAGE_OPTIONS,
	...
	@ConfigItem(
		keyName = FredsZulrahHelperPlugin.RANGE_COLOR_KEY,
		section = FredsZulrahHelperPlugin.SECTION_IMAGE_OPTIONS,
	...
	@ConfigItem(
		keyName = FredsZulrahHelperPlugin.MELEE_COLOR_KEY,
		section = FredsZulrahHelperPlugin.SECTION_IMAGE_OPTIONS,
	...
	@ConfigItem(
		keyName = FredsZulrahHelperPlugin.AUTO_HIDE_KEY,
		section = FredsZulrahHelperPlugin.SECTION_MISC,
	...
	@ConfigItem(
		keyName = FredsZulrahHelperPlugin.RESET_ON_LEAVE_KEY,
		section = FredsZulrahHelperPlugin.SECTION_MISC,
		name = "Reset on Leave",
	...
	@ConfigItem(
		...
		section = FredsZulrahHelperPlugin.SECTION_HOTKEYS,
		name = "Reset Phases",
