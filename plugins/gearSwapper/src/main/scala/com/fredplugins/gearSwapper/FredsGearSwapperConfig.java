...
@ConfigGroup(FredsGearSwapperConfig.CONFIG_GROUP)
public interface FredsGearSwapperConfig extends Config
{
    public static final String CONFIG_GROUP = "freds-gear-swapper";
    @ConfigSection(
            name = "General",
