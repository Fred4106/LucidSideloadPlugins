...
@ConfigGroup("freds-custom-prayers")
public interface FredsCustomPrayersConfig extends Config
{
    @ConfigSection(
            name = "General",
    ...
    @ConfigItem(
        name = "Dump data",
        description =  "Dumps all custom prayer data for debugging",
        position = 1,
        keyName = "dumpPresetHotkey",
        section = presetSection
    )
    default Keybind dumpPresetHotkey()
    {
    ...
    @ConfigItem(
            ...
            description =  "Loads the preset with the saved preset in your runelite/freds-custom-prayers/ folder",
            position = 2,
    ...
    @ConfigItem(
            ...
            description =  "Saves the preset as a JSON file to your runelite/freds-custom-prayers/ folder",
            position = 3,
