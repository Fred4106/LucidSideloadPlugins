...
import com.fredplugins.gauntlet.entity.Tornado;
    ...
    private void renderTornadoes(final Graphics2D graphics2D)
    {
        ...
        for (final Tornado tornado : plugin.getTornadoes())
        {
            ...
            if (config.tornadoTickCounter())
            {
                ...
                com.fredplugins.gauntlet.overlay.OverlayUtil.renderTextLocation(graphics2D, ticksLeftStr, config.tornadoFontSize(),
