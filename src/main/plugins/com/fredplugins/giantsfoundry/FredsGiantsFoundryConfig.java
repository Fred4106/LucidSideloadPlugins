...
@ConfigGroup(FredsGiantsFoundryConfig.GROUP)
public interface FredsGiantsFoundryConfig extends Config
{

	String GROUP = "fredsGiantsFoundry";
	String SOUND_ID = "soundID";
	String POINTS_KEY = "fredsGiantsFoundryPoints";
	...
	@ConfigItem(
		keyName = "infoTitle",
		name = "Title",
		description = "Toggle for \"Freds Giant's Foundry\" text",
		position = 0,
