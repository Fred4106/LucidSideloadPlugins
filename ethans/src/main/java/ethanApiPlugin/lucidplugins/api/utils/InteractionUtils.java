...
//    }
	...
	public static void useWidgetOnWidget(Widget widget, Widget widget2)
	{
		...
		Point w1P = new Point((int)widget.getBounds().getCenterX(),(int)widget.getBounds().getCenterY());
		Point w2P = new Point((int)widget2.getBounds().getCenterX(),(int)widget2.getBounds().getCenterY());
//		Widget widToClick =
